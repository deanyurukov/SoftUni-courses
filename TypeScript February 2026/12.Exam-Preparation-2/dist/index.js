...
const content_manager_1 = require("./content-manager");
...
async function main() {
    ...
    // ------------------------------------------------------------
    // Input 4 
    const manager = new content_manager_1.ContentManager();
    const duneMovie = new content_types_1.Movie(1, "Dune: Part Two", new Date("2024-03-01"), "Denis Villeneuve");
    const theLastOfUsSeries = new content_types_1.Series(2, "The Last of Us", new Date("2023-01-15"), "http://hbo.com/the-last-of-us");
    const inceptionMovie = new content_types_1.Movie(3, "Inception", new Date("2010-07-16"), "Christopher Nolan");
    const theCrownSeries = new content_types_1.Series(4, "The Crown", new Date("2016-11-04"), "http://netflix.com/the-crown");
    console.log(manager.addContent(duneMovie));
    console.log(manager.addContent(theLastOfUsSeries));
    console.log(manager.addContent(inceptionMovie));
    console.log(manager.addContent(theCrownSeries));
    const alice = { name: "Alice Smith", email: "alice@example.com" };
    const bob = { name: "Bob Johnson", email: "bob@example.com" };
    const charlie = { name: "Charlie Brown", email: "charlie@example.com" };
    console.log("\n--- MARKING AS WATCHED ---\n");
    console.log(manager.markAsWatched(1, alice));
    console.log(manager.markAsWatched(3, bob));
    console.log(manager.markAsWatched(3, charlie));
